...
| Manage Menu Bar Items | Opens two sortable lists for hidden and visible items; drag within a list to reorder or across lists to change visibility; requires Accessibility permission |
